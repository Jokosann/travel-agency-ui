		...
		<div className="flex flex-col">
			...
			<div className="max-w-3xl w-full mx-auto card__destinations">
				{dataDestinations.map((item) => (
					<div
						key={item.id}
						className="aspect-[1/1.6] relative overflow-hidden shadow-lg rounded-2xl hover:scale-105 transition-all"
					>
						...
						<div className="absolute bottom-0 bg-light w-full p-5 flex flex-col gap-3">
							<div className="flex justify-between">
								<p className="text-black-light text-lg font-medium">{item.place}</p>
