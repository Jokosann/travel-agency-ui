	...
	return (
		<div className="flex flex-col md:flex-row gap-4 sm:gap-0 md:gap-8">
			...
			<div className="w-full md:w-1/2 md:flex md:flex-col md:justify-center">
				<p className="font-bold uppercase text-sm text-orange-pink mb-3 font-poppins">
					Best Destinations around the world
				</p>
				<h1 className="text-5xl md:text-[2.5rem] lg:text-6xl font-bold font-volkhov mb-3 text-blue-dark">
					Travel, enjoy and live a new and full life
				</h1>
				<p className="font-poppins text-sm text-black-light mb-3 lg:pr-10">
				...
				<div className="flex gap-4">
					<button className="w-36 h-14 md:h-12 bg-yellow hover:opacity-90 shadow-2xl rounded-lg font-poppins text-light cursor-pointer active:translate-y-2 active:scale-95 transition-all">
						Find out more
					</button>
