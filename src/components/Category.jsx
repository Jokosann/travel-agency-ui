	...
	return (
		<div className="flex flex-col">
			<div className="w-full mb-14">
				...
				<h1 className="text-center font-volkhov text-3xl font-bold">We Offer Best Services</h1>
			</div>
				...
				{dataCategory.map((item, index) => (
					...
					>
						...
						<div className="h-full">
							<p className="text-center text-black-dark font-bold capitalize">{item.title}</p>
							<p className="text-center text-black-light whitespace-pre-line">{item.fill}</p>
						</div>
					</div>
				))}
			</div>
